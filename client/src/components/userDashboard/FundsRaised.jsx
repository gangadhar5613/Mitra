                ...
                <table className='border-l border-r border-2 border-red-800 rounded'>
                    <thead className='border-2  bg-red-800 text-white '>
                        <tr className=''>
                            ...
                            <th  className='w-96 border-l border-2 border-white text-xl'>Amount Donated</th>
                        </tr>
                    </thead>
...
function TableData(props){
    return(
        ...
        <td className='border-l border-2 border-black'>
            <button className='bg-green-600 rounded mr-2 text-white px-4 py-1'>Rs 10,000</button>
        </td>
    </tr>
    )
}
