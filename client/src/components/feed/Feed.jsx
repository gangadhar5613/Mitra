      ...
      <>
        ...
        <section className="py-20 container relative mx-auto">
          <div className="text-center relative flex flex-row items-center justify-center  font-semibold">
            ...
            <span className="flex h-12 w-12  right-64 fixed  top-64">
          ...
          <div className="flex flex-col ">
            <div className="mt-5  w-96 border-b-2  border-yellow-500  border-dashed  ml-32">
              <button onClick={this.handleFeed} id="bloodRequest" className={this.state.bloodRequestFeed ? "bg-yellow-400 text-black    mx-2  underline px-4 py-2" : "bg-red-700   mx-2 text-white px-4 py-2"}>
                Blood Requests
							</button>
            ...
            <div className="flex flex-row">
              <div className="ml-20 ">{this.state.bloodRequestFeed ? <BloodRequestFeed /> : <FundRaisingFeed />}</div>
              <div className="">
                <Filters />
              </div>
            </div>
