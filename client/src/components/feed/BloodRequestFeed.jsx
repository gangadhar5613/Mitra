...
function BloodRequestCard(props){
    return(
        <div class="blood-request-card border-2 cursor-pointer border-red-500 rounded bg-white mx-1 px-5 my-5 shadow-2xl p-2 w-full">
        <a href="">
          ...
          <div class="mx-3 py-2 flex justify-between">
