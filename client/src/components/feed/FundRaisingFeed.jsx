...
class FundRaisingFeed extends React.Component{
    ...
    render(){
        return(
            <article class="w-full bg-feed" id="dashboard">
...
function FundRaisingCard(props){
    return(
        <div class="blood-request-card relative  rounded-xl overflow-hidden bg-white mx-1 px-5 my-5 shadow-2xl p-2 w-full">
        <a href="">
            <div class="flex flex-row items-center part-1">
                 <div className='w-full absolute rounded-md -top-2 mb-5 left-0'>
                  ...
                  <div class="flex flex-row pt-10 items-center justify-between">
                       <div class="flex flex-col">
                           <h3 class="my-2 font-bold">Fund Raising</h3>
                           <div class="flex flex-col">
