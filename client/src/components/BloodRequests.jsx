...
function BloodRequestCard (props) {
  return (
    ...
    <div className="p-4 card md:mb-0 mb-6 flex flex-col ">
      ...
      <div className=" w-60 bg-white inset-0 transform  hover:scale-75 transition duration-300 cursor-pointer -mt-10 shadow-lg rounded-lg overflow-hidden p-5">
        ...
        <div className="header-content flex flex-col items-start justify-start ">
          <div className='flex items-start'>
            <div className="category-badge flex-1  h-8 w-8 flex items-center justify-center m rounded-full m-1 bg-red-700 text-white">
              <span>
                B+
                    </span>
            </div>
        ...
        <div className="title-post font-medium text-center">
