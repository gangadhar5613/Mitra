      ...
      <div className="flex flex-row mt-2">
        <div className="flex flex-col mr-2">
          ...
          <input
            ...
            id="bloodgroup"
            name="bloodgroup"
            className="bloodgroup w-96 mt-1 block   outline-none border-2 border-red-800  h-8  text-white shadow-lg hover:bg-red-700 focus:bg-black focus:ring-0"
            placeholder="Enter your bloodgroup number"
          ></input>
        </div>
        <div className="flex flex-col ml-2">
          <label
