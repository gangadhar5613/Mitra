		...
		<form>
			<div className="flex flex-wrap justify-between p-4">
				<div className="w-48 my-2">
					...
					<input required onChange={props.handleInput} type="text" id="firstName" name="firstName" className="block   outline-none border-2 border-red-800  text-white shadow-lg hover:bg-red-700 focus:bg-black focus:ring-0" placeholder="Enter your first name "></input>
				</div>
				<div className="w-48 my-2">
					<label htmlFor="middleName" className="text-md font-semibold text-shadow-md">
						Middle Name
					</label>
					<input required onChange={props.handleInput} type="text" id="middleName" name="middleName" className="block   outline-none border-2 border-red-800  text-white shadow-lg hover:bg-red-700 focus:bg-black focus:ring-0" placeholder="Enter your middle name "></input>
				</div>
				<div className="w-48 my-2">
					<label htmlFor="lastName" className="text-md font-semibold text-shadow-md">
						Last Name
					</label>
					<input required onChange={props.handleInput} type="text" id="lastName" name="lastName" className="block   outline-none border-2 border-red-800  text-white shadow-lg hover:bg-red-700 focus:bg-black focus:ring-0" placeholder="Enter your last name "></input>
				</div>
				<div className="w-48 my-2">
					<label htmlFor="email" className="text-md font-semibold text-shadow-md">
						Email
					</label>
					<input required onChange={props.handleInput} type="email" id="email" name="email" className="block   outline-none border-2 border-red-800  text-white shadow-lg hover:bg-red-700 focus:bg-black focus:ring-0" placeholder="Enter your email "></input>
				</div>
				<div className="w-48 my-2">
					<label htmlFor="dob" className="text-md font-semibold text-shadow-md">
						DOB
					</label>
					<input required onChange={props.handleInput} type="date" id="dob" name="dob" className="block   outline-none border-2 border-red-800  text-white shadow-lg hover:bg-red-700 focus:bg-black focus:ring-0" placeholder="Enter your email "></input>
				</div>
				<div className="w-48 my-2">
					<label htmlFor="bloodGroup" className="text-md font-semibold text-shadow-md">
						Blood Group
					</label>
					<select onChange={props.handleInput} className="block   outline-none border-2 border-red-800 text-white shadow-lg hover:bg-red-700 focus:bg-black focus:ring-0" name="bloodGroup" id="bloodGroup">
						<option>A+</option>
						<option>A-</option>
						<option>B+</option>
						<option>B-</option>
