                        ...
                        <div class="container px-5 py-10 mx-auto">
                            <div class="flex scroll  flex-row mx-6 overflow-x-scroll sm:-m-4  bg-scroll -mb-10 -mt-4">
                                <div class="p-4 md:w-1/3 md:mb-0 mb-6 flex flex-col justify-center items-center max-w-sm mx-auto">
                                    ...
                                    <div class=" w-70 inset-0 transform  cursor-pointer hover:scale-75 transition duration-300 bg-white -mt-10 shadow-lg rounded-lg overflow-hidden p-5">
                                ...
                                <div class="p-4 md:w-1/3 md:mb-0 mb-6 flex flex-col justify-center items-center max-w-sm mx-auto">
                                    ...
                                    <div class=" w-70 bg-white inset-0 transform cursor-pointer  hover:scale-75 transition duration-300 -mt-10 shadow-lg rounded-lg overflow-hidden p-5">
                                ...
                                <div class="p-4 md:w-1/3 md:mb-0 mb-6 flex flex-col justify-center items-center max-w-sm mx-auto">
                                    ...
                                    <div class=" w-70 bg-white -mt-10 inset-0 transform cursor-pointer  hover:scale-75 transition duration-300 shadow-lg rounded-lg overflow-hidden p-5">
