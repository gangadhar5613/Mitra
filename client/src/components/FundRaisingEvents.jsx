            ...
            <article className='mt-4'>
                ...
                <section class=" text-gray-700  ">
                        <div class="container px-5 py-10 mx-auto">
                            <div class="flex scroll   mx-6 overflow-x-scroll sm:-m-4  bg-scroll -mb-10 -mt-4">
                                <div class="p-4 md:w-1/3 md:mb-0 mb-6 flex flex-col justify-center items-center max-w-sm mx-auto">
                                    <div class="bg-gray-300 h-56 w-full rounded-lg shadow-md bg-cover bg-center" style={{backgroundImage: new URL('https://images.unsplash.com/photo-1521185496955-15097b20c5fe?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1951&q=80')}} ></div>
