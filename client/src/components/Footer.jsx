		...
		return (
			<div className="footer">
				<footer className="p-20 text-white flex items-center justify-around ">
					...
					{/*  */}
					<div className="2/12 h-1/2">
						<h6 className=" w-min text-2xl font-sans border-b-4 mb-6 ">Mitra</h6>
						<p>
					...
					<div className="2/12 items-center">
						<h6 className=" text-2xl font-sans mb-6 ">Registered Office Address</h6>

						<p>
							<i className="fas fa-map-marker-alt mr-3"></i> Dharamshala, Himachal Pradesh, India
						</p>
					</div>
					<div className=" 2/12 items-center">
						<h6 className=" w-full text-2xl font-sans  mb-4 ">Connect with us on :</h6>
				...
				<div className="pb-2 pt-0 flex items-center justify-center">
					...
					<div className="ml-6">
						<a>
							<i className=" text-black text-2xl fab fa-google-play"></i>
						</a>
						<a>
							<i className="text-black text-2xl ml-4 fab fa-app-store-ios"></i>
						</a>
					</div>
				</div>
			</div>
